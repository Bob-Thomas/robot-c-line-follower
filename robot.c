...
void left_turn(int rotation_speed) {
  motor[mLeft]  = rotation_speed * 0.3;
  motor[mRight] = rotation_speed * 2.5;
}

void right_turn(int rotation_speed) {
  motor[mLeft]  = rotation_speed * 2.5;
  motor[mRight] = rotation_speed * 0.3;
}
